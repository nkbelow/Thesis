...
module.exports = (parkCode) => {
  let query1 = 'SELECT activity FROM activities inner join activities_parks on (activities_parks.activity_id = activities.id AND activities_parks.park_id = (select id from parks where parkcode = $1))'; 
